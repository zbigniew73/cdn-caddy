(function () {
  ...
  var DICT = {
    pl: {
      ...
      pop_servers_hint: 'Rejestr maszyn POP do przyszlego wdrazania/synchronizacji configu Caddy przez SSH - niezalezny od GeoDNS wyzej.',
      pop_servers_empty: 'Brak dodanych serwerow POP.',
      pop_servers_sync_btn: 'Konfiguracja/Synchronizacja',
      pop_servers_sync_soon: 'Wkrotce - jeszcze niepodpiete.',
    ...
    en: {
      ...
      pop_servers_hint: 'Registry of POP machines for future Caddy config deployment/sync over SSH - independent from GeoDNS above.',
      pop_servers_empty: 'No POP servers added yet.',
      pop_servers_sync_btn: 'Configuration/Sync',
      pop_servers_sync_soon: 'Coming soon - not wired up yet.',
