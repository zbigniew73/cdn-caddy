(function () {
  ...
  var DICT = {
    pl: {
      ...
      caddy_config_placeholder: 'Do zbudowania w kolejnym kroku - zarzadzanie konfiguracja Caddy dla {host}.',
    ...
    en: {
      ...
      caddy_config_placeholder: 'To be built in the next step - managing the Caddy configuration for {host}.',
